  ...
  return (
    <div id="projects">
      <div>
        ...
        <ul>
          <ListItem
            title="Two-sided Marketplace Application"
            description={
              " helping parents to sell and buy second-hand baby essentials"
            }
          ></ListItem>
          <a href="https://github.com/AnaBondiguel/babyessentials.git">
            Baby Essentail Application Github
          </a>
          <ListItem
            title="Terminal Application"
            description={
              " building an application for a flower shop to sell and deliver fresh flowers to customers"
            }
          ></ListItem>
          <a href="https://github.com/AnaBondiguel/babyessentials.git">
            Bloom House Application Github
          </a>
          <ListItem
            title="Portfolio Website"
            description={
              " developing my personal website for potential employers and demonstrating my learning process of how I transformed my portfolio from HTML/CSS to React"
            }
          ></ListItem>
